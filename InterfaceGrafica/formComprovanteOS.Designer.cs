...
{
    partial class formComprovanteOS
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            // bsOS
            // 
            this.bsOS.DataSource = typeof(FROGI_OS.Relatorios.RelatorioOrdemServico);
            // 
            // reportViewer1
            // 
            ...
            reportDataSource2.Value = this.bsOS;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "FROGI_OS.Relatorios.RepComprovanteOrdemServico.rdlc";
            ...
            this.Name = "formComprovanteOS";
            this.ShowIcon = false;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Ordem de serviço";
            this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
            this.Load += new System.EventHandler(this.formComprovanteOS_Load);
